...
public class QUserFriends extends EntityPathBase<UserFriends> {
    ...
    private static final long serialVersionUID = -1213506027L;
    ...
    public final EnumPath<com.edu.ssafy.friend.model.entity.enums.UserFriendStatus> status = createEnum("status", com.edu.ssafy.friend.model.entity.enums.UserFriendStatus.class);
