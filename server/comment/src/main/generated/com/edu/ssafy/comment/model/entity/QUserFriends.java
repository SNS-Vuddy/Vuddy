...
public class QUserFriends extends EntityPathBase<UserFriends> {
    ...
    private static final long serialVersionUID = 1026227474L;
    ...
    public final EnumPath<com.edu.ssafy.comment.model.entity.enums.UserFriendStatus> status = createEnum("status", com.edu.ssafy.comment.model.entity.enums.UserFriendStatus.class);
