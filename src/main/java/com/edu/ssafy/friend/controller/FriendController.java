...
public class FriendController {
    ...
    @PostMapping("/add")
    public ResponseEntity<CommonRes> addFriend(@RequestHeader("x-forwarded-for-nickname") String encodedNickname, @RequestBody AddFriendReq req) {
        try {
    ...
    @PostMapping("/accept")
    public ResponseEntity<CommonRes> acceptFriend(@RequestHeader("x-forwarded-for-nickname") String encodedNickname, @RequestBody AddFriendReq req) {
        try {
            UserPair userPair = getRequesterAndReceiver(encodedNickname, req.getFriendNickname());
    ...
    // 친구 추가 요청 거절
    @PostMapping("/deny")
    public ResponseEntity<CommonRes> denyFriend(@RequestHeader("x-forwarded-for-nickname") String encodedNickname, @RequestBody AddFriendReq req) {
        try {
            UserPair userPair = getRequesterAndReceiver(encodedNickname, req.getFriendNickname());
            User requester = userPair.getReceiver();
            User receiver = userPair.getRequester();
    ...
    // 친구 삭제
    @PostMapping("/delete")
    public ResponseEntity<CommonRes> deleteFriend(@RequestHeader("x-forwarded-for-nickname") String encodedNickname, @RequestBody AddFriendReq req) {
        try {
            UserPair userPair = getRequesterAndReceiver(encodedNickname, req.getFriendNickname());
            User requester = userPair.getReceiver();
            User receiver = userPair.getRequester();
    ...
    //     내 친구 전체 조회
    @GetMapping("/all")
    public ResponseEntity<CommonRes> getAllFriend(@RequestHeader("x-forwarded-for-nickname") String encodedNickname) {
    ...
    // 친구, 유저 검색
    @GetMapping("/search")
    public ResponseEntity<CommonRes> searchFriend(@RequestHeader("x-forwarded-for-nickname") String encodedNickname, @RequestParam("nickname") String nickname) {
