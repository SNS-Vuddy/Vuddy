...
public class CommentController {
    ...
    public ResponseEntity<CommonRes> writeComment(@RequestHeader("x-forwarded-for-nickname") String encodedNickname, @PathVariable Long feedId, @RequestBody CommentWriteReq req) {
