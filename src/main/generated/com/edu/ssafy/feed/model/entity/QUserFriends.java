...
public class QUserFriends extends EntityPathBase<UserFriends> {
    ...
    private static final long serialVersionUID = 1430585173L;
    ...
    public final EnumPath<com.edu.ssafy.feed.model.entity.enums.UserFriendStatus> status = createEnum("status", com.edu.ssafy.feed.model.entity.enums.UserFriendStatus.class);
