...
class ChatRoomAdapter(private val profileLsit: ArrayList<Chat>) : RecyclerView.Adapter<ChatRoomAdapter.CustomViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        ...
        return CustomViewHolder(view).apply {
            itemView.setOnClickListener {
                ...
                val profile : Chat = profileLsit.get(curPos)
