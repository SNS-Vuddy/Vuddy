...
class feedDetailImageAdapter(private val feedimageList : List<String>) :
    ...
    override fun onBindViewHolder(holder: feedDetailImageAdapter.ViewHolder, position: Int) {
...
//            .override(1000,800)
    ...
    class ViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        ...
        val detailFeedimageViewRecyclerView = itemView.findViewById<ImageView>(R.id.iv_recycler_view_feed_images)
